...
namespace Biblotek.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Email,Name,Subject,Message")] ContactModel contactModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Name,Subject,Message")] ContactModel contactModel)
        {
